# openresty-dedicated-toolsets - Citalis-HHVM-Hack
...
2.- Drag n'Drop the 40x.html, 50x.html, citalis_hhl.php, citalis_hhs.php and citalis_php.html files to the same place.<br />
